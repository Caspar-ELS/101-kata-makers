...
Implement a city search functionality. The function takes a string (search text) as input and
...
1. If the search text is fewer than 2 characters, then should return no results. (It is an
   optimization feature of the search functionality.)
...
4. The search functionality should work also when the search text is just a part of a city name. For
