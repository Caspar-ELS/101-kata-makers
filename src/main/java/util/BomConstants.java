...
public class BomConstants {
  ...
  private static final String ORDER_MANAGEMENT = "order_management";
  private static final String FULFILLMENT = "fulfillment";
  private static final String REVENUE_RECOGNITION = "revenue_recognition";
  private static final String CORE_BOM = "core_bom";
  private static final String TEST_UTILITIES = "test_utilities";
