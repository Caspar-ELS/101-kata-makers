...
class ShowsDatabaseTest {
  ...
  @Test
  void willReturnEmptyListIfNoShowsAdded() {
    Assertions.assertEquals(List.of(), showsDatabase.getShows());
  }
  ...
  void willReturnListOfAddedShows() throws RequiredFieldsEmptyException {
    ...
    Assertions.assertEquals(List.of(newShow), showsDatabase.listAll());
  }
  ...
  void willReturnListOfShowsFromGivenYear() throws RequiredFieldsEmptyException {
    ...
    Assertions.assertEquals(List.of(showOne), showsDatabase.filterBy("yearReleased", "2018"));
  }
  ...
  void willReturnEmptyListIfNoShowsFromGivenYear() throws RequiredFieldsEmptyException {
    ...
    Assertions.assertEquals(List.of(), showsDatabase.filterBy("yearReleased","2016"));
  }
  ...
  void willReturnListOfShowsWithGivenTitle() throws RequiredFieldsEmptyException {
    ...
    Assertions.assertEquals(List.of(showOne), showsDatabase.filterBy("title", "Crime"));
  }
  ...
  void willReturnEmptyListIfNoShowsWithGivenTitle() throws RequiredFieldsEmptyException {
    ...
    Assertions.assertEquals(List.of(), showsDatabase.filterBy("title","Crime 3"));
  }
